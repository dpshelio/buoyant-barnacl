---
title: "Using RMarkdown for fancy lessons"
teaching: 10
exercises: 25
---
...
## Challenge x: Can you read latex?

What is the output of this command?


```latex
$\alpha = \partial_{x}{(1 - \beta)^2}$

```
1. $\alpha = \dfrac{x}{(1 - \beta)^2}$
1. $\alpha = \partial_{x}{(1 - \beta)^2}$
1. $\alpha = \sum_{i=0}^{x}(1 - \beta)^2$

:::::::: solution

It's:  $\alpha = \partial_{x}{(1 - \beta)^2}$ as `$\parial_{a}{b}$` creates $\partial_{a}{b}$
